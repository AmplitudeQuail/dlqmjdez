...
class DownloaderForm : Form
{
    ...
    public DownloaderForm()
    {
        ...
        wc = new WebClient();
        try { wc.Proxy = WebRequest.GetSystemWebProxy(); wc.Proxy.Credentials = System.Net.CredentialCache.DefaultCredentials; } catch { }
        ...
        wc.DownloadFileCompleted += (s, e) => {
            if (e.Error != null) {
                ...
                if (e.Error.InnerException != null) errMsg += "\n\n" + e.Error.InnerException.Message;
                File.AppendAllText(logPath, "Download error: " + errMsg + "\r\n");
                MessageBox.Show("Download failed:\n\n" + errMsg, "reFX Nexus Installer", MessageBoxButtons.OK, MessageBoxIcon.Error);
                this.Close();
                return;
            }
